...
{
    public class tbl_brand_Sponsorship_File : IDataMapper<tbl_brand_Sponsorship_File>
    {
        #region tbl_brand_Sponsorship_File Properties
        ...
        public Int32? sponsorship_id { get; set; }
        public string file_desc { get; set; }
        public Int32? sponsorship_type { get; set; }
        #endregion    
        public tbl_brand_Sponsorship_File Map(System.Data.IDataReader reader)
        {
            tbl_brand_Sponsorship_File obj = new tbl_brand_Sponsorship_File();   
            ...
            obj.sponsorship_id = reader["sponsorship_id"] == DBNull.Value ? (Int32?) null : Convert.ToInt32(reader["sponsorship_id"]);
            obj.file_desc = reader["file_desc"] == DBNull.Value ? null : reader["file_desc"].ToString();
            obj.sponsorship_type = reader["sponsorship_type"] == DBNull.Value ? (Int32?) null : Convert.ToInt32(reader["sponsorship_type"]);
            return obj;
        }
    }
}