...
{
    public class tbl_brand_Merchandise_hub_File : IDataMapper<tbl_brand_Merchandise_hub_File>
    {
        #region tbl_brand_Merchandise_hub_File Properties
        ...
        public Int32? Merchandise_hub_type { get; set; }
        #endregion    
        public tbl_brand_Merchandise_hub_File Map(System.Data.IDataReader reader)
        {
            tbl_brand_Merchandise_hub_File obj = new tbl_brand_Merchandise_hub_File();   
            ...
            obj.Merchandise_hub_type = reader["Merchandise_hub_type"] == DBNull.Value ? (Int32?) null : Convert.ToInt32(reader["Merchandise_hub_type"]);
            return obj;
        }
    }
}