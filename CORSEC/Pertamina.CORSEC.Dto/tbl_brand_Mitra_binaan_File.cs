...
{
    public class tbl_brand_Mitra_binaan_File : IDataMapper<tbl_brand_Mitra_binaan_File>
    {
        #region tbl_brand_Mitra_binaan_File Properties
        ...
        public Int32? Mitra_binaan_type { get; set; }
        #endregion    
        public tbl_brand_Mitra_binaan_File Map(System.Data.IDataReader reader)
        {
            tbl_brand_Mitra_binaan_File obj = new tbl_brand_Mitra_binaan_File();   
            ...
            obj.Mitra_binaan_type = reader["Mitra_binaan_type"] == DBNull.Value ? (Int32?) null : Convert.ToInt32(reader["Mitra_binaan_type"]);
            return obj;
        }
    }
}