...
{
    public class tbl_Kinerja_Sekper_File : IDataMapper<tbl_Kinerja_Sekper_File>
    {
        #region tbl_Kinerja_Sekper_File Properties
        ...
        #endregion    
        public tbl_Kinerja_Sekper_File Map(System.Data.IDataReader reader)
        {
            tbl_Kinerja_Sekper_File obj = new tbl_Kinerja_Sekper_File();   
