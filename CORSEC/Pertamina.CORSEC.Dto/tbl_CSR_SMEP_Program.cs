...
{
    public class tbl_CSR_SMEP_Program : IDataMapper<tbl_CSR_SMEP_Program>
    {
        #region tbl_CSR_SMEP_Program Properties
        ...
        public Int32? related_document { get; set; }
        ...
        public Int32? is_dynamic { get; set; }
        public Int32? ROW_NUMBER { get; set; }
        #endregion    
        public tbl_CSR_SMEP_Program Map(System.Data.IDataReader reader)
        {
            tbl_CSR_SMEP_Program obj = new tbl_CSR_SMEP_Program();   
            ...
            obj.related_document = reader["related_document"] == DBNull.Value ? (Int32?) null : Convert.ToInt32(reader["related_document"]);
            obj.category = reader["category"] == DBNull.Value ? (Int32?) null : Convert.ToInt32(reader["category"]);
            ...
            obj.is_dynamic = reader["is_dynamic"] == DBNull.Value ? (Int32?) null : Convert.ToInt32(reader["is_dynamic"]);
            obj.ROW_NUMBER = reader["ROW_NUMBER"] == DBNull.Value ? (Int32?) null : Convert.ToInt32(reader["ROW_NUMBER"]);
            return obj;
        }
    }
}