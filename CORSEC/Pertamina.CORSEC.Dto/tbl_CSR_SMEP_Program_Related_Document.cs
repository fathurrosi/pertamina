...
{
    public class tbl_CSR_SMEP_Program_Related_Document : IDataMapper<tbl_CSR_SMEP_Program_Related_Document>
    {
        #region tbl_CSR_SMEP_Program_Related_Document Properties
        ...
        #endregion    
        public tbl_CSR_SMEP_Program_Related_Document Map(System.Data.IDataReader reader)
        {
            tbl_CSR_SMEP_Program_Related_Document obj = new tbl_CSR_SMEP_Program_Related_Document();   
