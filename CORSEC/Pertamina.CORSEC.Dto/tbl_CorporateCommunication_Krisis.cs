...
{
    public class tbl_CorporateCommunication_Krisis : IDataMapper<tbl_CorporateCommunication_Krisis>
    {
        #region tbl_CorporateCommunication_Krisis Properties
        ...
        public Int32? SubCategory { get; set; }
        public Int32? Jenis_Documen { get; set; }
        public Int32? Tahun { get; set; }
        #endregion    
        public tbl_CorporateCommunication_Krisis Map(System.Data.IDataReader reader)
        {
            tbl_CorporateCommunication_Krisis obj = new tbl_CorporateCommunication_Krisis();   
            ...
            obj.SubCategory = reader["SubCategory"] == DBNull.Value ? (Int32?) null : Convert.ToInt32(reader["SubCategory"]);
            obj.Jenis_Documen = reader["Jenis_Documen"] == DBNull.Value ? (Int32?) null : Convert.ToInt32(reader["Jenis_Documen"]);
