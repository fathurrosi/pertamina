...
{
    public class tbl_CorporateCommunication_Sub_Category : IDataMapper<tbl_CorporateCommunication_Sub_Category>
    {
        #region tbl_CorporateCommunication_Sub_Category Properties
        ...
        #endregion    
        public tbl_CorporateCommunication_Sub_Category Map(System.Data.IDataReader reader)
        {
            tbl_CorporateCommunication_Sub_Category obj = new tbl_CorporateCommunication_Sub_Category();   
            obj.id = Convert.ToInt64(reader["id"]);
            obj.Category = reader["Category"] == DBNull.Value ? (Int64?) null : Convert.ToInt64(reader["Category"]);
