...
{
    public class tbl_Media_File : IDataMapper<tbl_Media_File>
    {
        #region tbl_Media_File Properties
        ...
        #endregion    
        public tbl_Media_File Map(System.Data.IDataReader reader)
        {
            tbl_Media_File obj = new tbl_Media_File();   
