...
namespace Pertamina.CORSEC.Dto.Cstm
{
    public class tbl_product_related : IDataMapper<tbl_product_related>
    {
        ...
        public tbl_product_related Map(System.Data.IDataReader reader)
        {
            ...
            obj.product_parent_id = reader["product_parent_id"] == DBNull.Value ? 0 : Convert.ToInt32(reader["product_parent_id"]);
            obj.product_id = reader["product_id"] == DBNull.Value ? 0 : Convert.ToInt32(reader["product_id"]);
