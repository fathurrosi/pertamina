...
{
    public class tbl_Stake_Holder_Management_Diplomatic_Intelegence : IDataMapper<tbl_Stake_Holder_Management_Diplomatic_Intelegence>
    {
        #region tbl_Stake_Holder_Management_Diplomatic_Intelegence Properties
        ...
        #endregion    
        public tbl_Stake_Holder_Management_Diplomatic_Intelegence Map(System.Data.IDataReader reader)
        {
            tbl_Stake_Holder_Management_Diplomatic_Intelegence obj = new tbl_Stake_Holder_Management_Diplomatic_Intelegence();
            ...
            obj.country = reader["country"] == DBNull.Value ? (Int32?)null : Convert.ToInt32(reader["country"]);
            ...
            obj.PAGING_ROW_NUMBER = reader["PAGING_ROW_NUMBER"] == DBNull.Value ? (Int32?)null : Convert.ToInt32(reader["PAGING_ROW_NUMBER"]);
