...
namespace Pertamina.CORSEC.Dto.Cstm
{
    public class tbl_brand_Merchandise_hub_related : IDataMapper<tbl_brand_Merchandise_hub_related>
    {
        ...
        public int Merchandise_hub_parent_id { get; set; }
        public int Merchandise_hub_id { get; set; }
        #endregion    
        public tbl_brand_Merchandise_hub_related Map(System.Data.IDataReader reader)
        {
            ...
            obj.Merchandise_hub_parent_id = reader["Merchandise_hub_parent_id"] == DBNull.Value ? 0 : Convert.ToInt32(reader["Merchandise_hub_parent_id"]);
            obj.Merchandise_hub_id = reader["Merchandise_hub_id"] == DBNull.Value ? 0 : Convert.ToInt32(reader["Merchandise_hub_id"]);
