...
{
    public class tbl_CSR_SMEP_Program_Category : IDataMapper<tbl_CSR_SMEP_Program_Category>
    {
        #region tbl_CSR_SMEP_Program_Category Properties
        ...
        #endregion    
        public tbl_CSR_SMEP_Program_Category Map(System.Data.IDataReader reader)
        {
            tbl_CSR_SMEP_Program_Category obj = new tbl_CSR_SMEP_Program_Category();   
