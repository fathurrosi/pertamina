...
{
    public class tbl_brand_Exhibition_File : IDataMapper<tbl_brand_Exhibition_File>
    {
        #region tbl_brand_Exhibition_File Properties
        ...
        public Int32? exhibition_id { get; set; }
        public string file_desc { get; set; }
        public Int32? exhibition_type { get; set; }
        #endregion    
        public tbl_brand_Exhibition_File Map(System.Data.IDataReader reader)
        {
            tbl_brand_Exhibition_File obj = new tbl_brand_Exhibition_File();   
            ...
            obj.exhibition_id = reader["exhibition_id"] == DBNull.Value ? (Int32?) null : Convert.ToInt32(reader["exhibition_id"]);
            obj.file_desc = reader["file_desc"] == DBNull.Value ? null : reader["file_desc"].ToString();
            obj.exhibition_type = reader["exhibition_type"] == DBNull.Value ? (Int32?) null : Convert.ToInt32(reader["exhibition_type"]);
            return obj;
        }
    }
}