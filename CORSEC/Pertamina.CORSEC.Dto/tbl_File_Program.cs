...
{
    public class tbl_File_Program : IDataMapper<tbl_File_Program>
    {
        #region tbl_File_Program Properties
        ...
        #endregion    
        public tbl_File_Program Map(System.Data.IDataReader reader)
        {
            tbl_File_Program obj = new tbl_File_Program();   
