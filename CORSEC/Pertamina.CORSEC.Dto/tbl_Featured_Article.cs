...
{
    public class tbl_Featured_Article : IDataMapper<tbl_Featured_Article>
    {
        #region tbl_Featured_Article Properties
        ...
        public string youtube_code { get; set; }
        #endregion    
        public tbl_Featured_Article Map(System.Data.IDataReader reader)
        {
            tbl_Featured_Article obj = new tbl_Featured_Article();   
            ...
            obj.youtube_code = reader["youtube_code"] == DBNull.Value ? null : reader["youtube_code"].ToString();
            return obj;
        }
    }
}