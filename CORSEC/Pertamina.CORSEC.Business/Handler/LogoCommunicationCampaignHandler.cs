...
{
    public class LogoCommunicationCampaignHandler : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            try
            {
                ...
                tbl_brand_Communication_Campaign_logo file = tbl_brand_Communication_Campaign_logoItem.GetByPK(_id);
