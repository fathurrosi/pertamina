...
{
  public  class FileCommunicationCampaignHandler : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            try
            {
                ...
                tbl_brand_Communication_Campaign_user_manual file = tbl_brand_Communication_Campaign_user_manualItem.GetByPK(_id);
