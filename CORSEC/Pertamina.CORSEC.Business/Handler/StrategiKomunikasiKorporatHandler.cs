...
{
    public class StrategiKomunikasiKorporatHandler : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            try
            {
                ...
                tbl_CorporateCommunication_Corporate file = tbl_CorporateCommunication_CorporateItem.GetByPK(_id);
                ...
                if (file != null && file.file_blob != null)
                {
                    ...
                    tbl_CorporateCommunication_CorporateItem.Update(file);
