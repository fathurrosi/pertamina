...
{
    public partial class Exhibition_Detail : CORSECPage
    {
        #region Event Paging
        protected void grid_RowDataBound(Object sender, GridViewRowEventArgs e)
        {
            ...
            else if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                if (!string.IsNullOrEmpty(hdn.Value))
                {
                    ...
                    linkFile.NavigateUrl = ResolveUrl(string.Format("~/ExhibitionFileHandler.ashx?id={0}", hdn.Value));
                }
        ...
        void BindingDataMateri_And_Poster()
        {
            ...
            gridMateri_And_Poster.DataSource = tbl_brand_Exhibition_FileItem.GetDataPaging(ItemID, pageIndex, pageSizeMateri_And_Poster, out totalRows);
...
";
                ...
                tbl_brand_Exhibition contentItem = tbl_brand_ExhibitionItem.GetByPK(ItemID);
                if (contentItem != null)
                {
                    ...
                    List<tbl_brand_Exhibition_File> _files = tbl_brand_Exhibition_FileItem.GetGalery(contentItem.id);
                    string imageTemplate = @"<li><img src=""{0}"" alt=""photo"" /></li>
";
                    foreach (tbl_brand_Exhibition_File _file in _files)
                    {
