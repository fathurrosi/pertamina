<%@ Page Title="" Language="C#" MasterPageFile="~/Frontend.Master" AutoEventWireup="true" CodeBehind="merchandise-hub-detail.aspx.cs" Inherits="Pertamina.CORSEC._2019.Brand.merchandise_hub_detail" EnableEventValidation="false" %>
            ...
            <div class="kt-portlet">
                <div class="kt-portlet__body">
                    <div class="kt-portlet__content mb-4">
                        <a href="merchandise-hub.aspx" class="btn btn-secondary mb-4" runat="server" id="btnBack"><i class="fa fa-less-than"></i>Back</a>
                        <div class="row">
                            <div class="col-md-6">
