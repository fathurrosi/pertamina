...
{
    public partial class Merchandise_hub : CORSECPage
    {
        public int Category
        {
            get
        ...
        {
            // $$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$ filter filter $$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$            
            List<tbl_Combo_Detail> categoryList = tbl_Combo_DetailItem.GetByHeader("Merchandise_hub_Category");
...
{0}</button>", selectedCategory);
            ...
            {
                string _url = string.Format("Merchandise-hub.aspx{0}&c={1}&s={2}", PrevUrl, _item.id, Sort);
        ...
        {
            // $$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$ filter sort $$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
            List<DataItem> list = Utilities.GetDataSource<Merchandise_Sort>();
...
{0}</button>", selectedTtext);
            ...
            {
                string _url = string.Format("Merchandise-hub.aspx{0}&c={1}&s={2}", PrevUrl, Category, _item.Code);
                filterTemplate += string.Format(@"
...
";
                tbl_File_Template item = tbl_File_TemplateItem.GetByTemplateType((int)TemplateType.Merchandise_hub);
                if (item != null)
                {
        ...
        void BindingDataMerchandiseHub()
        {
            ...
            listViewMerchandiseHub.DataSource = tbl_productItem.GetPagingCustom(pageIndex, pageSizeMerchandiseHub, selectedCategory, (int)product_type.Merchandise_hub, Sort, out totalRows);
