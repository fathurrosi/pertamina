<%@ Page Title="" Language="C#" MasterPageFile="~/Backend.Master" AutoEventWireup="true" CodeBehind="corporate-communication.aspx.cs" Inherits="Pertamina.CORSEC._2019.Admin.Programs.corporate_communication"  EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    ...
    <asp:ObjectDataSource ID="obj" TypeName="Pertamina.CORSEC.Dta.tbl_ProgramItem" EnablePaging="true" runat="server"
        MaximumRowsParameterName="PageSize"
        StartRowIndexParameterName="StartRowIndex"
        SelectCountMethod="GetCountByTipeProgram"
        SelectMethod="GetPagingByTipeProgram">

        <SelectParameters>
            <asp:Parameter Name="StartRowIndex" Type="Int32" />
            <asp:Parameter Name="PageSize" Type="Int32" />
            <asp:Parameter Name="tipeProgram" Type="String" DefaultValue="15" />
        </SelectParameters>
