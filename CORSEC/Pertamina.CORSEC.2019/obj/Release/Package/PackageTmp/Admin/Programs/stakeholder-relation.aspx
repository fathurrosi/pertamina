<%@ Page Title="" Language="C#" MasterPageFile="~/Backend.Master" AutoEventWireup="true" CodeBehind="stakeholder-relation.aspx.cs" Inherits="Pertamina.CORSEC._2019.Admin.Programs.stakeholder_relation"   EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    ...
    <asp:ObjectDataSource ID="obj" TypeName="Pertamina.CORSEC.Dta.tbl_ProgramItem" EnablePaging="true" runat="server"
        ...
        <SelectParameters>
            ...
            <asp:Parameter Name="tipeProgram" Type="String" DefaultValue="16" />
        </SelectParameters>
