<%@ Page Title="" Language="C#" MasterPageFile="~/Backend.Master" AutoEventWireup="true" CodeBehind="stake-holder.aspx.cs"
    Inherits="Pertamina.CORSEC._2019.Admin.StakeHolderManagement.Details.stake_holder" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-2">
            <asp:TextBox ID="txtTahun" runat="server" MaxLength="4" class="form-control year"></asp:TextBox>
        </div>
    </div>
