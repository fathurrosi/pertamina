<%@ Page Title="" Language="C#" MasterPageFile="~/Backend.Master" AutoEventWireup="true" CodeBehind="Items.aspx.cs" Inherits="Pertamina.CORSEC._2019.Admin.Mitra.Items" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    ...
    <asp:ObjectDataSource ID="obj" TypeName="Pertamina.CORSEC.Dta.tbl_productItem" EnablePaging="true" runat="server"
        ...
        <SelectParameters>
            ...
            <asp:Parameter Name="product_type" Type="Int32" DefaultValue="654" />
        </SelectParameters>
