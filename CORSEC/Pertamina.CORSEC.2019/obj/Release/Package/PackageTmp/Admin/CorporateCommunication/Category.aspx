<%@ Page Title="" Language="C#" MasterPageFile="~/Backend.Master" AutoEventWireup="true" CodeBehind="Category.aspx.cs" Inherits="Pertamina.CORSEC._2019.Admin.CorporateCommunication.Category" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
        ...
        <Columns>
            <asp:TemplateField HeaderText="Action" HeaderStyle-Width="70px">
                <ItemTemplate>
                    ...
                    <asp:HyperLink ID="hlAdd" runat="server" ToolTip="Tambah Sub Kategori"><i class="fa fa-copy"></i></asp:HyperLink>
                </ItemTemplate>
            </asp:TemplateField>
    ...
    <asp:ObjectDataSource ID="obj" TypeName="Pertamina.CORSEC.Dta.tbl_CorporateCommunication_CategoryItem" EnablePaging="true" runat="server"
