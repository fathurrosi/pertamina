<%@ Page Title="" Language="C#" MasterPageFile="~/Backend.Master" AutoEventWireup="true" CodeBehind="Doc.aspx.cs" Inherits="Pertamina.CORSEC._2019.Admin.Guidelines.Details.Doc" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    ...
    <div class="form-group">
        <label class="control-label col-sm-2">No Dokumen</label>
        <div class="col-sm-6">
            <asp:DropDownList ID="ddlTipe_Dokumen" runat="server" CssClass="form-control" AutoPostBack="false"></asp:DropDownList>
        </div>
    </div>
    ...
    <div class="form-group">
        <label class="control-label col-sm-2">No Dokumen</label>
        <div class="col-sm-6">
            <asp:TextBox ID="txtNoDoc" runat="server" CssClass="form-control"></asp:TextBox>
        </div>
    </div>
