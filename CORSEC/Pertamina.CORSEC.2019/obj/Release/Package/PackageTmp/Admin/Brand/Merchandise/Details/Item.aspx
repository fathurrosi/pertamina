<%@ Page Title="" Language="C#" MasterPageFile="~/Backend.Master" AutoEventWireup="true" CodeBehind="Item.aspx.cs" Inherits="Pertamina.CORSEC._2019.Admin.Brand.Merchandise.Details.Item" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    ...
    <div class="form-group">
        <div class="col-sm-12" style="text-align: center">
            <div class="row">
                <asp:ListView ID="listViewMerchandise_hub" runat="server">
                    <EmptyDataTemplate>
                        <div class="form-group">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="kt-portlet kt-portlet--height-fluid kt-widget19">
                                <div class="kt-portlet__body kt-portlet__body--fit kt-portlet__body--unfill">
                                    <a title="klik untuk edit atau hapus." href='<%# ResolveUrl(string.Format("~/Admin/Brand/Merchandise/Details/Item-Add.aspx{0}&pid={1}&id={2}", PrevUrl, Eval("product_id"), Eval("id"))) %>' class="kt-widget19__username">
