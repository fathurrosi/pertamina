<%@ Page Title="" Language="C#" MasterPageFile="~/Backend.Master" AutoEventWireup="true" CodeBehind="logo-guidance.aspx.cs" Inherits="Pertamina.CORSEC._2019.Admin.Brand.Details.logo_guidance" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    ...
    <div class="form-group">
        <label class="control-label col-sm-2">Keterangan Gambar</label>
        <div class="col-sm-6">
            <asp:TextBox ID="lblImageDesc" runat="server" CssClass="form-control"></asp:TextBox>
        </div>
    </div>
