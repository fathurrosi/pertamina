<%@ Page Title="" Language="C#" MasterPageFile="~/Backend.Master" AutoEventWireup="true" CodeBehind="media-monitoring.aspx.cs" Inherits="Pertamina.CORSEC._2019.Admin.MonitoringEvaluasi.media_monitoring" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    ...
    <asp:GridView ID="grid" DataSourceID="obj" runat="server" class="table table-bordered table-striped"
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="Tipe Monitoring">
                <ItemTemplate>
                    <%# Eval("Monitoring_Type")%>
                </ItemTemplate>
            </asp:TemplateField>

            <asp:TemplateField HeaderText="Tipe Media">
                <ItemTemplate>
                    <%# Eval("Media_Type")%>
                </ItemTemplate>
            </asp:TemplateField>

            <asp:TemplateField HeaderText="Nada Berita">
                <ItemTemplate>
                    <%# Eval("Tone")%>
                </ItemTemplate>
            </asp:TemplateField>
    ...
    <asp:ObjectDataSource ID="obj" TypeName="Pertamina.CORSEC.Dta.tbl_MonitoringEvaluasi_MediaItem" EnablePaging="true" runat="server"
