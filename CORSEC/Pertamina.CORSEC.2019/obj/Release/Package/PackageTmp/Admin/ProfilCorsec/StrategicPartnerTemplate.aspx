<%@ Page Title="" Language="C#" MasterPageFile="~/Backend.Master" AutoEventWireup="true" CodeBehind="StrategicPartnerTemplate.aspx.cs" Inherits="Pertamina.CORSEC._2019.Admin.ProfilCorsec.StrategicPartnerTemplate"  EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-6">
            <asp:TextBox ID="lblPage_title" runat="server" class="form-control"></asp:TextBox>
        </div>
    </div>
    <hr />
