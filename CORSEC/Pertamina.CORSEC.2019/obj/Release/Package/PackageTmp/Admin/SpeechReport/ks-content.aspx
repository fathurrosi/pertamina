<%@ Page Title="" Language="C#" MasterPageFile="~/Backend.Master" AutoEventWireup="true" CodeBehind="ks-content.aspx.cs" Inherits="Pertamina.CORSEC._2019.Admin.SpeechReport.ks_content" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    ...
    <asp:GridView ID="grid" DataSourceID="obj" runat="server" class="table table-bordered table-striped"
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="Isi">
                <ItemTemplate>
                    <asp:Image ID="imgFile" runat="server" Width="100" Height="100" alt="" ImageUrl='<%# Pertamina.CORSEC.Business.Utilities.ByteToString((byte[]) Eval("file_blob")) %>' />
                </ItemTemplate>
            </asp:TemplateField>
    ...
    <asp:ObjectDataSource ID="obj" TypeName="Pertamina.CORSEC.Dta.tbl_Kinerja_SekperItem" EnablePaging="true" runat="server"
        MaximumRowsParameterName="PageSize"
        StartRowIndexParameterName="PageIndex"
        SelectCountMethod="Get_Count"
        SelectMethod="Get_Paging">
