<%@ Page Title="" Language="C#" MasterPageFile="~/Backend.Master" AutoEventWireup="true" CodeBehind="EmailBroadcast.aspx.cs" Inherits="Pertamina.CORSEC._2019.Admin.SpeechReport.EmailBroadcast"  EnableEventValidation="false" %>
 ...
 <br />
    ...
    <asp:ObjectDataSource ID="obj" TypeName="Pertamina.CORSEC.Dta.tbl_Board_Speech_PresentationItem" EnablePaging="true" runat="server"
        ...
        <SelectParameters>
            ...
            <asp:Parameter Name="data_type" Type="Int32" DefaultValue="3" />
        </SelectParameters>
