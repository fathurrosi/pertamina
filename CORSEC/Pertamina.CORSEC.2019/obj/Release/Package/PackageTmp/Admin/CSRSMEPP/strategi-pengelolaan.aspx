<%@ Page Title="" Language="C#" MasterPageFile="~/Backend.Master" AutoEventWireup="true" CodeBehind="strategi-pengelolaan.aspx.cs"
    Inherits="Pertamina.CORSEC._2019.Admin.CSRSMEPP.strategi_pengelolaan" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    ...
    <asp:ObjectDataSource ID="obj" TypeName="Pertamina.CORSEC.Dta.tbl_CSR_SMEP_ProgramItem" EnablePaging="true" runat="server"
        ...
        SelectCountMethod="GetPagingStrategiPengelolaanCount"
        SelectMethod="GetPagingStrategiPengelolaan">
