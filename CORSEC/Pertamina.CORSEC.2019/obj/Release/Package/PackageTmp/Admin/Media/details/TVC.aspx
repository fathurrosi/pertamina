<%@ Page Title="" Language="C#" MasterPageFile="~/Backend.Master" AutoEventWireup="true" CodeBehind="TVC.aspx.cs" Inherits="Pertamina.CORSEC._2019.Admin.Media.details.TVC" EnableEventValidation="false" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="script" runat="server">
    <script>
        //var _video = videojs('example_video_1');

        //if (_video.readyState() < 1) {
        //    // wait for loadedmetdata event
        //    _video.one("loadedmetadata", onLoadedMetadata);
        //}
        //else {
        ...
        //    var total_minutes = parseInt(_video.duration() / 60, 10);
        //    var seconds = Math.floor(_video.duration() % 60);
