<%@ Page Title="" Language="C#" MasterPageFile="~/Backend.Master" AutoEventWireup="true" CodeBehind="kalender.aspx.cs" Inherits="Pertamina.CORSEC._2019.Admin.CollateralCorporate.Details.kalender" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    ...
    <div class="form-group" runat="server" id="divTipeKalender">
        <label class="control-label col-sm-2">Tipe Kalender</label>
        <div class="col-sm-6">
            <asp:DropDownList ID="ddlTipeKalender" runat="server" class="form-control"></asp:DropDownList>
        </div>
    </div>
    ...
    <div class="form-group">
        <label class="control-label col-sm-2">Diskripsi</label>
        <div class="col-sm-10">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-6">
            <asp:TextBox ID="lblSeq" runat="server" class="form-control"></asp:TextBox>
        </div>
    </div>
