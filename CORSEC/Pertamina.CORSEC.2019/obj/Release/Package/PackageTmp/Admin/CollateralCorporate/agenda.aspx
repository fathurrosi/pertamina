<%@ Page Title="" Language="C#" MasterPageFile="~/Backend.Master" AutoEventWireup="true" CodeBehind="agenda.aspx.cs" Inherits="Pertamina.CORSEC._2019.Admin.CollateralCorporate.agenda" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    ...
    <asp:ObjectDataSource ID="obj" TypeName="Pertamina.CORSEC.Dta.tbl_Collateral_Corporate_ItemItem" EnablePaging="true" runat="server"
        ...
        <SelectParameters>
            ...
            <asp:Parameter Name="Category" Type="String" DefaultValue="Agenda"  />
        </SelectParameters>
