...
{
    public partial class presentasi : AuthorizeAdminPage
    {
        //public string PrevUrl { get; set; }
        protected void btnCreate_Click(object sender, EventArgs e)
        {
            string selectedDocType = ddlTipe.SelectedValue;
            Response.Redirect(ResolveUrl(string.Format("~/Admin/SpeechReport/Details/presentasi.aspx{0}&tp={1}", PrevUrl, selectedDocType)));
        }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                //ddlTipe.DataSource = Utilities.;
                //ddlTipe.DataBind();

                ddlTipe.DataTextField = "Text";
                ddlTipe.DataValueField = "Code";
                ddlTipe.DataSource = Utilities.GetDataSource<Business.Enum.Speech_Report_Type>();
                ddlTipe.DataBind();
            }
        ...
        protected void grid_RowDataBound(Object sender, GridViewRowEventArgs e)
        {
            ...
            else if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                hlEdit.NavigateUrl = string.Format("~/Admin/SpeechReport/Details/presentasi.aspx{0}&id={1}&t=e", PrevUrl, hiddenField.Value);
                ...
                if (!string.IsNullOrEmpty(hdnFileID.Value)) linkFile.NavigateUrl = ResolveUrl(string.Format("~/SpeechReportHandler.ashx?FileID={0}", hdnFileID.Value));
            }
        }
        ...
        protected void lb_Click(object sender, EventArgs e)
        {
            ...
            tbl_Board_Speech_PresentationItem.Delete(_id);
