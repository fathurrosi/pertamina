...
{
    public partial class EmailBroadcast : AuthorizeAdminPage
    {
        //public string PrevUrl { get; set; }
        protected void btnCreate_Click(object sender, EventArgs e)
        {
            string selectedDocType = string.Format("{0}", (int)Speech_Report_Type.EmailBroadcast);
            Response.Redirect(ResolveUrl(string.Format("~/Admin/SpeechReport/Details/EmailBroadcast.aspx{0}&tp={1}", PrevUrl, selectedDocType)));
        }
        ...
        protected void grid_RowDataBound(Object sender, GridViewRowEventArgs e)
        {
            ...
            else if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                hlEdit.NavigateUrl = string.Format("~/Admin/SpeechReport/Details/EmailBroadcast.aspx{0}&id={1}&t=e", PrevUrl, hiddenField.Value);
