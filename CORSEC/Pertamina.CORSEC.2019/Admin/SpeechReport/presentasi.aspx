<%@ Page Title="" Language="C#" MasterPageFile="~/Backend.Master" AutoEventWireup="true" CodeBehind="presentasi.aspx.cs" Inherits="Pertamina.CORSEC._2019.Admin.SpeechReport.presentasi" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    ...
    <asp:ObjectDataSource ID="obj" TypeName="Pertamina.CORSEC.Dta.tbl_Board_Speech_PresentationItem" EnablePaging="true" runat="server"
        MaximumRowsParameterName="PageSize"
        StartRowIndexParameterName="StartRowIndex"
        SelectCountMethod="GetCountByTipe"
        SelectMethod="GetPagingByTipe">

        <SelectParameters>
            <asp:Parameter Name="StartRowIndex" Type="Int32" />
            <asp:Parameter Name="PageSize" Type="Int32" />
            <asp:ControlParameter Name="data_type" PropertyName="SelectedValue" Type="Int32" DefaultValue="4" ControlID="ddlTipe" />
        </SelectParameters>
