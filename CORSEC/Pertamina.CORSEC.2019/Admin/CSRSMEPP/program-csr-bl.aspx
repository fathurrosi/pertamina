<%@ Page Title="" Language="C#" MasterPageFile="~/Backend.Master" AutoEventWireup="true" CodeBehind="program-csr-bl.aspx.cs"
    Inherits="Pertamina.CORSEC._2019.Admin.CSRSMEPP.program_csr_bl" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
        ...
        <Columns>
            <asp:TemplateField HeaderText="Action" HeaderStyle-Width="70px">
                <ItemTemplate>
                    ...
                    <asp:HyperLink ID="hlAdd" runat="server" ToolTip="Tambah Sub Kategori" Visible="false"><i class="fa fa-copy"></i></asp:HyperLink>
                </ItemTemplate>
            </asp:TemplateField>
            ...
            <asp:TemplateField HeaderText="Related Document">
                <ItemTemplate>
                    <asp:Label ID="lblrelated_document" runat="server" />
                    <asp:HiddenField ID="hdnrelated_document" runat="server" Value='<%# Eval("related_document")%>' />
                </ItemTemplate>
            </asp:TemplateField>
    ...
    <asp:ObjectDataSource ID="obj" TypeName="Pertamina.CORSEC.Dta.tbl_CSR_SMEP_ProgramItem" EnablePaging="true" runat="server"
        MaximumRowsParameterName="PageSize"
        StartRowIndexParameterName="PageIndex"
        SelectCountMethod="GetPagingPengelolaanCSRBLCount"
        SelectMethod="GetPagingPengelolaanCSRBL">
