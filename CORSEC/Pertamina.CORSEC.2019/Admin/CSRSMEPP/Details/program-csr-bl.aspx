<%@ Page Title="" Language="C#" MasterPageFile="~/Backend.Master" AutoEventWireup="true" CodeBehind="program-csr-bl.aspx.cs"
    Inherits="Pertamina.CORSEC._2019.Admin.CSRSMEPP.Details.program_csr_bl" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    ...
    <div class="form-group" runat="server" visible="true">
        ...
        <div class="col-sm-6">
            <asp:DropDownList ID="ddlKateori" runat="server" class="form-control" AutoPostBack="true" OnSelectedIndexChanged="ddlKateori_SelectedIndexChanged"></asp:DropDownList>
        </div>
    </div>

    <div class="form-group" runat="server" id="tabDiv" visible="true">
    ...
    <div class="form-group" runat="server" id="tahunDiv" visible="false">
    ...
    <div class="form-group" runat="server" id="bulanDiv" visible="true">
        <label class="control-label col-sm-2">Bulan</label>
        <div class="col-sm-2">
            <asp:DropDownList ID="ddlBulan" runat="server" class="form-control"></asp:DropDownList>
        </div>
    </div>


    <div class="form-group" runat="server" id="docDiv" visible="true">
