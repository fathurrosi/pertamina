    ...
    public partial class program_csr_bl : AuthorizeAdminPage
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                List<DataItem> CSR_SMEP_ProgramType_List = Utilities.GetDataSource<CSR_SMEP_ProgramType>().Where(t => t.Code == "3" || t.Code == "4").ToList();
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            if (result != null)
            {
                Response.Redirect(ResolveUrl(string.Format("~/Admin/CSRSMEPP/program-csr-bl.aspx{0}", PrevUrl)));
            }
        }
