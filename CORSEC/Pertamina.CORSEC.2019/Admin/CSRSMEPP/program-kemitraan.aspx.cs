...
namespace Pertamina.CORSEC._2019.Admin.CSRSMEPP
{
    public partial class program_kemitraan : AuthorizeAdminPage
    {
        ...
        {
            Response.Redirect(ResolveUrl(string.Format("~/Admin/CSRSMEPP/Details/program.aspx{0}&t=mit", PrevUrl)));
        }
        ...
        protected void grid_RowDataBound(Object sender, GridViewRowEventArgs e)
        {
            ...
            else if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                hyperLink.NavigateUrl = string.Format("~/Admin/CSRSMEPP/Details/program.aspx{0}&id={1}&t=mit", PrevUrl, hiddenField.Value);
