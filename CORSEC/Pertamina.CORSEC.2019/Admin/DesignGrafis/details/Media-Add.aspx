<%@ Page Title="" Language="C#" MasterPageFile="~/Backend.Master" AutoEventWireup="true" CodeBehind="Media-Add.aspx.cs" Inherits="Pertamina.CORSEC._2019.Admin.DesignGrafis.details.Media_Add" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    ...
    <div runat="server" id="textContainer">
        <div class="form-group">
