<%@ Page Title="" Language="C#" MasterPageFile="~/Backend.Master" AutoEventWireup="true" CodeBehind="Print-Ad.aspx.cs" Inherits="Pertamina.CORSEC._2019.Admin.DesignGrafis.Print_Ad" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    ...
    <asp:ObjectDataSource ID="obj" TypeName="Pertamina.CORSEC.Dta.tbl_Design_GrafisItem" EnablePaging="true" runat="server"
        ...
        <SelectParameters>
            ...
            <asp:ControlParameter ControlID="ddldata_type" Name="data_type" Type="Int32" DefaultValue="0" PropertyName="SelectedValue" />
