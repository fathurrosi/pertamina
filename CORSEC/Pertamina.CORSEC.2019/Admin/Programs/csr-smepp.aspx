<%@ Page Title="" Language="C#" MasterPageFile="~/Backend.Master" AutoEventWireup="true" CodeBehind="csr-smepp.aspx.cs" Inherits="Pertamina.CORSEC._2019.Admin.Programs.csr_smepp"   EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    ...
    <asp:ObjectDataSource ID="obj" TypeName="Pertamina.CORSEC.Dta.tbl_ProgramItem" EnablePaging="true" runat="server"
        ...
        <SelectParameters>
            ...
            <asp:Parameter Name="tipeProgram" Type="String" DefaultValue="17" />
        </SelectParameters>
