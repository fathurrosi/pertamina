...
{
    public partial class stakeholder_relation : AuthorizeAdminPage
    {
        //public string PrevUrl { get; set; }
        protected void btnCreate_Click(object sender, EventArgs e)
        {
            //string selectedDocType = ddlTipe_Dokumen.SelectedValue;
            Response.Redirect(ResolveUrl(string.Format("~/Admin/Programs/Details/Contents.aspx{0}&tp={1}", PrevUrl, (int)Business.Enum.Tipe_Program.Stakeholder_Relation)));
        }
