...
namespace Pertamina.CORSEC._2019.Admin.Programs
{
    public partial class corporate_communication : AuthorizeAdminPage
    {
        //public string PrevUrl { get; set; }
        protected void btnCreate_Click(object sender, EventArgs e)
        {
            //string selectedDocType = ddlTipe_Dokumen.SelectedValue;
            Response.Redirect(ResolveUrl(string.Format("~/Admin/Programs/Details/Contents.aspx{0}&tp={1}", PrevUrl, (int)Business.Enum.Tipe_Program.Corporate_Communication)));
        }
        ...
        protected void grid_RowDataBound(Object sender, GridViewRowEventArgs e)
        {
            ...
            else if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                hlEdit.NavigateUrl = string.Format("~/Admin/Programs/Details/Contents.aspx{0}&id={1}&tp={2}", PrevUrl, hiddenField.Value, (int)Business.Enum.Tipe_Program.Corporate_Communication);
