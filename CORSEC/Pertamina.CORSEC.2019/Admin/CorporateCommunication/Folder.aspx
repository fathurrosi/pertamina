<%@ Page Title="" Language="C#" MasterPageFile="~/Backend.Master" AutoEventWireup="true" CodeBehind="Folder.aspx.cs" Inherits="Pertamina.CORSEC._2019.Admin.CorporateCommunication.Folder" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    ...
    <asp:ObjectDataSource ID="obj" TypeName="Pertamina.CORSEC.Dta.tbl_CorporateCommunication_Sub_CategoryItem" EnablePaging="true" runat="server"
        MaximumRowsParameterName="PageSize"
        StartRowIndexParameterName="PageIndex"
        SelectCountMethod="GetByFKCount"
        SelectMethod="GetByFKPaging">

        <SelectParameters>
            <asp:Parameter Name="PageIndex" Type="Int32" />
            <asp:Parameter Name="PageSize" Type="Int32" />
            <asp:QueryStringParameter Name="CategoryID" QueryStringField="pid" Type="Int64" />
        </SelectParameters>
