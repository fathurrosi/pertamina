<%@ Page Title="" Language="C#" MasterPageFile="~/Backend.Master" AutoEventWireup="true"  EnableEventValidation="false" CodeBehind="Anggota.aspx.cs" Inherits="Pertamina.CORSEC._2019.Admin.Organization.Anggota" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    ...
    <asp:GridView ID="grid" DataSourceID="obj" runat="server" class="table table-bordered table-striped"
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="Nama Anggota">
                <ItemTemplate>
                    <%# Eval("nama")%>
                </ItemTemplate>
            </asp:TemplateField>
           ...
           <asp:TemplateField HeaderText="Telp">
                <ItemTemplate>
                    <%# Eval("telp")%>
                </ItemTemplate>
            </asp:TemplateField>
    ...
    <asp:ObjectDataSource ID="obj" TypeName="Pertamina.CORSEC.Dta.tbl_Struktur_Organisasi_AnggotaItem" EnablePaging="true" runat="server"
        MaximumRowsParameterName="PageSize"
        StartRowIndexParameterName="PageIndex"
        SelectCountMethod="GetCount"
        SelectMethod="GetAnggota">
