...
namespace Pertamina.CORSEC._2019.Admin.Organization
{
    public partial class Anggota : AuthorizeAdminPage
    {
        ...
        {
            Response.Redirect(ResolveUrl(string.Format("~/Admin/Organization/Details/Anggota.aspx{0}", PrevUrl)));
        }
        ...
        protected void grid_RowDataBound(Object sender, GridViewRowEventArgs e)
        {
            ...
            else if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                hyperLink.NavigateUrl = string.Format("~/Admin/Organization/Details/Anggota.aspx{0}&id={1}&t=e", PrevUrl, hiddenField.Value);
        ...
        protected void lb_Click(object sender, EventArgs e)
        {
            ...
            tbl_Struktur_Organisasi_AnggotaItem.Delete(_id);
