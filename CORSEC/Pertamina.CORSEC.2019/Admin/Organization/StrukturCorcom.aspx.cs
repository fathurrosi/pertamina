...
namespace Pertamina.CORSEC._2019.Admin.Organization
{
    public partial class StrukturCorcom : AuthorizeAdminPage
    {
        ...
        {
            Response.Redirect(ResolveUrl(string.Format("~/Admin/Organization/Details/StrukturCorcom.aspx{0}", PrevUrl)));
        }
        ...
        protected void grid_RowDataBound(Object sender, GridViewRowEventArgs e)
        {
            ...
            else if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                hlEdit.NavigateUrl = string.Format("~/Admin/Organization/Details/StrukturCorcom.aspx{0}&id={1}&t=e", PrevUrl, hiddenField.Value);

                HyperLink hlAdd = e.Row.FindControl("hlAdd") as HyperLink;
                hlAdd.NavigateUrl = string.Format("~/Admin/Organization/Details/StrukturCorcom.aspx{0}&pid={1}&t=a", PrevUrl, hiddenField.Value);
        ...
        protected void lb_Click(object sender, EventArgs e)
        {
            ...
            tbl_Struktur_Organisasi_Diagram_CorcomItem.Delete(_id);
