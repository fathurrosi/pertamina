...
namespace Pertamina.CORSEC._2019.Admin.StakeHolderManagement
{
    public partial class stake_holder : AuthorizeAdminPage
    {
        ...
        {
            Response.Redirect(ResolveUrl(string.Format("~/Admin/StakeHolderManagement/Details/stake-holder.aspx{0}", PrevUrl)));
        }
        ...
        protected void grid_RowDataBound(Object sender, GridViewRowEventArgs e)
        {
            ...
            else if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                hyperLink.NavigateUrl = string.Format("~/Admin/StakeHolderManagement/Details/stake-holder.aspx{0}&id={1}&t=e", PrevUrl, hiddenField.Value);
        ...
        protected void lb_Click(object sender, EventArgs e)
        {
            ...
            tbl_Stake_Holder_Management_Stake_Holder_DatabaseItem.Delete(_id);
