...
namespace Pertamina.CORSEC._2019.Admin.StakeHolderManagement
{
    public partial class diplomatic_intelegence : AuthorizeAdminPage
    {
        ...
        {
            Response.Redirect(ResolveUrl(string.Format("~/Admin/StakeHolderManagement/Details/diplomatic-intelegence.aspx{0}", PrevUrl)));
        }
        ...
        protected void grid_RowDataBound(Object sender, GridViewRowEventArgs e)
        {
            ...
            else if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                hyperLink.NavigateUrl = string.Format("~/Admin/StakeHolderManagement/Details/diplomatic-intelegence.aspx{0}&id={1}&t=e", PrevUrl, hiddenField.Value);
        ...
        protected void lb_Click(object sender, EventArgs e)
        {
            ...
            tbl_Stake_Holder_Management_Diplomatic_IntelegenceItem.Delete(_id);
