...
{
    public partial class Logo : AuthorizeAdminPage
    {

        //public string PrevUrl { get; set; }
        protected void btnCreate_Click(object sender, EventArgs e)
        {
            Response.Redirect(ResolveUrl(string.Format("~/Admin/Brand/Details/CC-Logo.aspx{0}", PrevUrl)));
        }
        ...
        protected void grid_RowDataBound(Object sender, GridViewRowEventArgs e)
        {
            ...
            else if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                hlEdit.NavigateUrl = string.Format("~/Admin/Brand/Details/CC-Logo.aspx{0}&id={1}&t=e", PrevUrl, hiddenField.Value);
        ...
        protected void lb_Click(object sender, EventArgs e)
        {
            ...
            tbl_brand_Communication_Campaign_logoItem.Delete(_id);
