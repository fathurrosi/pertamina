<%@ Page Title="" Language="C#" MasterPageFile="~/Backend.Master" AutoEventWireup="true" CodeBehind="Exhibition.aspx.cs" Inherits="Pertamina.CORSEC._2019.Admin.Brand.Details.Exhibition" EnableEventValidation="false" %>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="kt-portlet kt-portlet--height-fluid kt-widget19">
                                <div class="kt-portlet__body kt-portlet__body--fit kt-portlet__body--unfill">
                                    <a title="klik untuk edit atau hapus." href='<%# ResolveUrl(string.Format("~/Admin/Brand/Details/Exhibition-Add.aspx{0}&pid={1}&id={2}", PrevUrl, Eval("exhibition_id"), Eval("id"))) %>' class="kt-widget19__username">
