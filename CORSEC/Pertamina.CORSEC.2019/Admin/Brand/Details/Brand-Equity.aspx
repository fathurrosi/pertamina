<%@ Page Title="" Language="C#" MasterPageFile="~/Backend.Master" AutoEventWireup="true" CodeBehind="Brand-Equity.aspx.cs" Inherits="Pertamina.CORSEC._2019.Admin.Brand.Details.Brand_Equity"  EnableEventValidation="false" %>
...
<%--    <div class="form-group">
    ...
    <div class="form-group">
        <label class="control-label col-sm-2">Posisi Gambar</label>
        <div class="col-sm-6">
