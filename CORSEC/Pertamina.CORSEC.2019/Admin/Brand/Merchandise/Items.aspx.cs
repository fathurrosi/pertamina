...
namespace Pertamina.CORSEC._2019.Admin.Brand.Merchandise
{
    public partial class Items : AuthorizeAdminPage
    {
        ...
        {
            Response.Redirect(ResolveUrl(string.Format("~/Admin/Brand/Merchandise/Details/Item.aspx{0}", PrevUrl)));
        }
        ...
        protected void grid_RowDataBound(Object sender, GridViewRowEventArgs e)
        {
            ...
            else if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                hlEdit.NavigateUrl = string.Format("~/Admin/Brand/Merchandise/Details/Item.aspx{0}&id={1}&t=e", PrevUrl, hiddenField.Value);
