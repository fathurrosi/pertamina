...
namespace Pertamina.CORSEC._2019.Admin.Brand.Merchandise.Details
{
    public partial class Item : AuthorizeAdminPage
    {
        protected void lb_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect(ResolveUrl(string.Format("~/Admin/Brand/Merchandise/Details/Item.aspx{0}&id={1}", PrevUrl, ItemID)));
        }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                ddlCategory.DataSource = tbl_Combo_DetailItem.GetByHeader("Merchandise_hub_Category");
                ...
                if (item != null)
                {
                    ...
                    listViewMerchandise_hub.DataSource = files.Where(t => t.Merchandise_Type == (int)MerchandiseType.Gallery).ToList();
                    listViewMerchandise_hub.DataBind();
        ...
        protected void btnAddFile_Click(object sender, EventArgs e)
        {
            ...
            if (item == null)
            {
                ...
                item.product_type = (int)product_type.Merchandise_hub;
            }
            else
            {
            ...
            if (result != null)
            {
                Response.Redirect(ResolveUrl(string.Format("~/Admin/Brand/Merchandise/Details/Item-Related.aspx{0}&pid={1}", PrevUrl, result.id)));
            }
        }
        protected void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            if (result != null)
            {
                Response.Redirect(ResolveUrl(string.Format("~/Admin/Brand/Merchandise/Details/Item-Add.aspx{0}&pid={1}", PrevUrl, result.id)));
            }
        }
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect(ResolveUrl(string.Format("~/Admin/Brand/Merchandise/Items.aspx{0}", PrevUrl)));
