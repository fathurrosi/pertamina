<%@ Page Title="" Language="C#" MasterPageFile="~/Backend.Master" AutoEventWireup="true" CodeBehind="Items.aspx.cs" Inherits="Pertamina.CORSEC._2019.Admin.Brand.Merchandise.Items" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
   ...
   <%--
         ...
         <%--   <asp:TemplateField HeaderText="Logo">
                <ItemTemplate>
                    <asp:Image runat="server" Width="400" ImageUrl='<%# ConvertUrl(Eval("file_blob"))%>'></asp:Image>
                </ItemTemplate>
            </asp:TemplateField>--%>
    ...
    <asp:ObjectDataSource ID="obj" TypeName="Pertamina.CORSEC.Dta.tbl_productItem" EnablePaging="true" runat="server"
        ...
        <SelectParameters>
            ...
            <asp:Parameter Name="product_type" Type="Int32" DefaultValue="987" />
        </SelectParameters>
