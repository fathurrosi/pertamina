<%@ Page Title="" Language="C#" MasterPageFile="~/Backend.Master" AutoEventWireup="true" CodeBehind="template.aspx.cs" Inherits="Pertamina.CORSEC._2019.Admin.Brand.template" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    ...
    <div class="form-group">
        <label class="control-label col-sm-2">Template Untuk</label>
        <div class="col-sm-6">
    ...
    <div class="form-group">
        <label class="control-label col-sm-2">Header Template</label>
        <div class="col-sm-6">
            <asp:TextBox ID="lblHeader" runat="server" class="form-control"></asp:TextBox>
        </div>
    </div>
