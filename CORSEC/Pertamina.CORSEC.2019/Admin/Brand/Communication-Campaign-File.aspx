<%@ Page Title="" Language="C#" MasterPageFile="~/Backend.Master" AutoEventWireup="true" CodeBehind="Communication-Campaign-File.aspx.cs" 
Inherits="Pertamina.CORSEC._2019.Admin.Brand.Communication_Campaign_File" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
        ...
        <Columns>
            <asp:TemplateField HeaderText="Action" HeaderStyle-Width="70px">
                <ItemTemplate>
                    ...
                    <asp:LinkButton runat="server" ID="lbDel" ToolTip="Delete" OnClick="lb_Click" CommandArgument='<%# Eval("id")%>'><i class="far fa-trash-alt" ></i></asp:LinkButton>
                </ItemTemplate>
            </asp:TemplateField>
            ...
            <asp:TemplateField HeaderText="Logo">
                <ItemTemplate>
                    <asp:Image runat="server" Width="400" ImageUrl='<%# ConvertUrl(Eval("image_blob"))%>'></asp:Image>
    ...
    <asp:ObjectDataSource ID="obj" TypeName="Pertamina.CORSEC.Dta.tbl_brand_Communication_Campaign_user_manualItem" EnablePaging="true" runat="server"
