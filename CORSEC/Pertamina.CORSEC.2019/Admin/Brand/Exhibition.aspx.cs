...
namespace Pertamina.CORSEC._2019.Admin.Brand
{
    ...
    {        
        ...
        {
            Response.Redirect(ResolveUrl(string.Format("~/Admin/Brand/Details/Exhibition.aspx{0}", PrevUrl)));
        }
        ...
        protected void grid_RowDataBound(Object sender, GridViewRowEventArgs e)
        {
            ...
            else if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                hlEdit.NavigateUrl = string.Format("~/Admin/Brand/Details/Exhibition.aspx{0}&id={1}&t=e", PrevUrl, hiddenField.Value);
        ...
        protected void lb_Click(object sender, EventArgs e)
        {
            ...
            tbl_brand_ExhibitionItem.Delete(_id);
