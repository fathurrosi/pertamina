<%@ Page Title="" Language="C#" MasterPageFile="~/Backend.Master" AutoEventWireup="true" CodeBehind="Infografis-corporate.aspx.cs" Inherits="Pertamina.CORSEC._2019.Admin.Media.Infografis_corporate" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    ...
    <asp:ObjectDataSource ID="obj" TypeName="Pertamina.CORSEC.Dta.tbl_MediaItem" EnablePaging="true" runat="server"
        ...
        <SelectParameters>
            ...
            <asp:Parameter Name="infographic_type" Type="Int32" DefaultValue="1" />
