...
{
    public partial class Media_external : AuthorizeAdminPage
    {
        protected void lb_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect(ResolveUrl(string.Format("~/Admin/Media/Details/Media-external.aspx{0}&id={1}", PrevUrl, ItemID)));
        }
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            item.infographic_type = (int)Infographic_Type.Media_external;
