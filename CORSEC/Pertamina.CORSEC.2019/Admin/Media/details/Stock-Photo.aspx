<%@ Page Title="" Language="C#" MasterPageFile="~/Backend.Master" AutoEventWireup="true" CodeBehind="Stock-Photo.aspx.cs" Inherits="Pertamina.CORSEC._2019.Admin.Media.details.Stock_Photo" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    ...
    <div class="form-group">
        <div class="col-sm-12">
            <asp:Button ID="btnAdd" runat="server" Text="Tambah Detail Photo" OnClick="btnAdd_Click" />
        </div>
    </div>
