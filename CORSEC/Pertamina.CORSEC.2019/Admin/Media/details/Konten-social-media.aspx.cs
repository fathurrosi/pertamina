...
namespace Pertamina.CORSEC._2019.Admin.Media.details
{
    public partial class Konten_social_media : AuthorizeAdminPage
    {
        protected void lb_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect(ResolveUrl(string.Format("~/Admin/Media/Details/Konten-social-media.aspx{0}&id={1}", PrevUrl, ItemID)));
        }
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            item.infographic_type = (int)Infographic_Type.Konten_social_media;
