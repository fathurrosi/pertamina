<%@ Page Title="" Language="C#" MasterPageFile="~/Backend.Master" AutoEventWireup="true" CodeBehind="agenda.aspx.cs" Inherits="Pertamina.CORSEC._2019.Admin.CollateralCorporate.Details.agenda" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-6">
            <asp:TextBox ID="lblSeq" runat="server" CssClass="form-control"></asp:TextBox>
        </div>
    </div>
