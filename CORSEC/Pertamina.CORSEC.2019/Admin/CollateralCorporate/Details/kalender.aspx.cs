...
namespace Pertamina.CORSEC._2019.Admin.CollateralCorporate.Details
{
    public partial class kalender : AuthorizeAdminPage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                if (item != null)
                {
                    ...
                    ddlTipeKalender.SelectedValue = item.calender_type;
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            item.year = year;
            item.calender_type = ddlTipeKalender.SelectedValue;
            ...
            if (result != null)
            {
                ...
                Response.Redirect(ResolveUrl(string.Format("~/Admin/CollateralCorporate/kalender.aspx{0}", PrevUrl)));
            }
        }
