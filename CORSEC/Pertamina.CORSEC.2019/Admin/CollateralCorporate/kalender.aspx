<%@ Page Title="" Language="C#" MasterPageFile="~/Backend.Master" AutoEventWireup="true" EnableEventValidation="false"   CodeBehind="kalender.aspx.cs" Inherits="Pertamina.CORSEC._2019.Admin.CollateralCorporate.kalender" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    ...
    <asp:ObjectDataSource ID="obj" TypeName="Pertamina.CORSEC.Dta.tbl_Collateral_Corporate_ItemItem" EnablePaging="true" runat="server"
        MaximumRowsParameterName="PageSize"
        StartRowIndexParameterName="PageIndex"
        SelectCountMethod="GetCountByCategory"
        SelectMethod="GetPagingByCategory">
        <SelectParameters>
            <asp:Parameter Name="PageIndex" Type="Int32" />
            <asp:Parameter Name="PageSize" Type="Int32" />
            <asp:Parameter Name="Category" Type="String" DefaultValue="Kalender" />
        </SelectParameters>
