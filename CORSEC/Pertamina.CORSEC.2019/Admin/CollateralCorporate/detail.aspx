<%@ Page Title="" Language="C#" MasterPageFile="~/Backend.Master" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="detail.aspx.cs" Inherits="Pertamina.CORSEC._2019.Admin.CollateralCorporate.detail" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
        ...
        <Columns>
            <asp:TemplateField HeaderText="Action" HeaderStyle-Width="70px">
                <ItemTemplate>
                    ...
                    <asp:LinkButton runat="server" ID="lbDel" ToolTip="Delete" OnClick="lb_Click" Visible="false"><i class="far fa-trash-alt" ></i></asp:LinkButton>
                    <asp:HyperLink ID="hlAddFile" runat="server" ToolTip="Tambah Gambar"><i class="fa fa-camera-retro"></i></asp:HyperLink>
            ...
            <asp:TemplateField HeaderText="Diskripsi">
                <ItemTemplate>
                    <%# Eval("body")%>
                </ItemTemplate>
            </asp:TemplateField>
    ...
    <asp:ObjectDataSource ID="obj" TypeName="Pertamina.CORSEC.Dta.tbl_Collateral_Corporate_DetailItem" EnablePaging="true" runat="server"
