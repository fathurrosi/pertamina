...
namespace Pertamina.CORSEC._2019.Admin.About
{
    public partial class info : AuthorizeAdminPage
    {
        ...
        {
            Response.Redirect(ResolveUrl(string.Format("~/Admin/About/Details/info.aspx{0}", PrevUrl)));
        }
        ...
        protected void grid_RowDataBound(Object sender, GridViewRowEventArgs e)
        {
            ...
            else if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                hyperLink.NavigateUrl = string.Format("~/Admin/About/Details/info.aspx{0}&id={1}&t=e", PrevUrl, hiddenField.Value);
