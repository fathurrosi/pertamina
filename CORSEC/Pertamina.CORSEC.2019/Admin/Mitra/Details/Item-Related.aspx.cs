...
namespace Pertamina.CORSEC._2019.Admin.Mitra.Details
{
    public partial class Item_Related : AuthorizeAdminPage
    {
        protected void lb_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect(ResolveUrl(string.Format("~/Admin/Details/Item.aspx{0}&id={1}", PrevUrl, ItemID)));
        }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                List<tbl_product> parentList = tbl_productItem.GetByProduct_Type((int)product_type.Mitra_binaan);
