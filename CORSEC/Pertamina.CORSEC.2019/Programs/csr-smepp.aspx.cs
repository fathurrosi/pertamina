...
{
    public partial class csr_smepp : System.Web.UI.Page
    {
...
";
            ...
            {
                string result = "";
                List<tbl_Program> list = tbl_ProgramItem.GetByTipeProgram(((int)Business.Enum.Tipe_Program.CSR_Smepp).ToString());
