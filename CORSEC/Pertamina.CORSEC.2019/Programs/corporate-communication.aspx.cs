...
{
    public partial class corporate_communication : System.Web.UI.Page
    {
...
";
            ...
            {
                string result = "";
                List<tbl_Program> list = tbl_ProgramItem.GetByTipeProgram(((int)Business.Enum.Tipe_Program.Corporate_Communication).ToString());
