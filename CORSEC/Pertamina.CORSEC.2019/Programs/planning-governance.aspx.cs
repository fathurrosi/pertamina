...
{
    public partial class planning_governance : System.Web.UI.Page
    {
...
";
            ...
            {
                string result = "";
                List<tbl_Program> list = tbl_ProgramItem.GetByTipeProgram(((int)Business.Enum.Tipe_Program.Planning_Governance).ToString());
