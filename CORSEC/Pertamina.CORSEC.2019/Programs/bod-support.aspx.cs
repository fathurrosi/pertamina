...
{
    public partial class bod_support : System.Web.UI.Page
    {
...
";
            ...
            {
                string result = "";
                List<tbl_Program> list = tbl_ProgramItem.GetByTipeProgram(((int)Business.Enum.Tipe_Program.BOD_Support).ToString());
