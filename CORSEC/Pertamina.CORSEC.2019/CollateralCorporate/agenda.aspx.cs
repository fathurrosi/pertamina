...
namespace Pertamina.CORSEC._2019.CollateralCorporate
{
    ...
    public partial class agenda : CORSECPage
    {
...
";
                ...
                tbl_File_Template itemTemplate = tbl_File_TemplateItem.GetByTemplateType((int)TemplateType.Collateral_Corporate_Agenda);
...
", selectedArchive);
                    ...
                    {
                        string _url = (Year > 1900) ? string.Format("agenda.aspx{0}&id={1}&y={2}&ar={3}", PrevUrl, item.id, selectedYear, _archive.Archive) : string.Format("agenda.aspx{0}&id={1}&ar={2}", PrevUrl, item.id, _archive.Archive);
                    ...
                    {
                        string _url = string.Format("agenda.aspx{0}&id={1}&y={2}&ar={3}", PrevUrl, item.id, i, selectedArchive);
                        if (i % 2 == 0)
                        {
                            filterTahun += string.Format(@"
<div class=""kt-widget4__item p-2"">
    <a href=""{1}"" class=""kt-widget4__title kt-widget4__title--light"">Agenda tahun {0}
    </a>
