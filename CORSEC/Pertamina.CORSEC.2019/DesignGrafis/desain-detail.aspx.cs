...
{
    public partial class desain_detail : CORSECPage
    {
...
";
                ...
                tbl_File_Template templateItem = tbl_File_TemplateItem.GetByTemplateType((int)TemplateType.Desain);
                ...
                if (item != null)
                {
                    ...
                    lblImages.Text = "";
                    aBack.HRef = ResolveUrl(string.Format("~/DesignGrafis/desain.aspx{0}&tab={1}", PrevUrl, item.data_type));
